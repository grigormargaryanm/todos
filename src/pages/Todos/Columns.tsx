  ...
  return (
    <Skeleton isLoading={isLoading}>
      <Dropdown trigger={['click']} menu={{ items }}>
        <EllipsisButton data-testid='ellipsis-button' icon={<MoreOutlined />} type='text' />
      </Dropdown>
    </Skeleton>
  )
}
  ...
  return [
    {
      ...
      width: '20%',
      ellipsis: true,
      render: (_, { title }) => <Title title={title} isLoading={isLoading} />,
    },
    {
      title: 'Description',
    ...
    },
    {
      ...
      dataIndex: 'status',
      width: '20%',
      render: (_, { status }) => <Status status={status} isLoading={isLoading} />,
    },
    {
      title: 'Deadline',
      dataIndex: 'deadline',
      width: '20%',
      render: (_, { deadline }) => <Deadline deadline={deadline} isLoading={isLoading} />,
    },
    {
      title: '',
      dataIndex: 'states',
      ...
      align: 'center',
      render: (_, todo) => (
        <Actions todo={todo} isLoading={isLoading} handleCurrentTodo={handleCurrentTodo} />
      ),
    },
  ]
}
